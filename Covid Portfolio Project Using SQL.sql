...
Skills used: Joins, Alias, CTE's, Temp Tables, Windows Functions, Aggregate Functions, Creating Views, Converting Data Types
*/

--Creating the DataBase for our Project
Create Database PORTFOLIOPROJECT
Use PORTFOLIOPROJECT

--Data stored in the Covid Deaths.xlsx
...
Select *, (RollingPeopleVaccinated/Population)*100 as PeopleVaccinatedPerPopulation
